      ...
      <div className="mx-auto md:px-5 py-12 md:max-w-5xl">
        ...
        <div className="text-right mt-10">
          <Link href={'/articles/page/1'}>
            <button className="bg-gray-700 dark:bg-gray-600 hover:bg-gray-800 dark:hover:bg-gray-500 py-2 px-4 rounded-lg inline-flex items-center text-white transition-colors duration-200">
              <span>記事一覧 ＞</span>
            </button>
          </Link>
        </div>
